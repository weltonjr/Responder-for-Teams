...
3. Give the bot a handle (ex: `responderBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://teste2.azurewebsites.net/api/messages`
